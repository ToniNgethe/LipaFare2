...
import com.example.toni.lipafare.Passanger.PassangerAdapter.PastTripsAdapter;
...
public class Past extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fragment_passed, container, false);

        //views
        rv = (RecyclerView) mView.findViewById(R.id.rv_cancelled_frag);
        linearLayout = (LinearLayout) mView.findViewById(R.id.linear_past);
                ...
                for (final DataSnapshot ds:dataSnapshot.getChildren()){
                    ...
                    cs.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (Integer.valueOf(dataSnapshot.child("status").getValue().toString()) == 1) {
                                ...
                                PastTripsAdapter upcomingTripsAdapter = new PastTripsAdapter(getActivity(), myTickets, ticketKeys);
