...
import com.example.toni.lipafare.Passanger.PassangerDialog.ChangeUserNameDialog;
...
public class PassangerAccountFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        change_image = (FloatingActionButton) mView.findViewById(R.id.fab_account_change_pic);
        ...
        profile = (ImageView) mView.findViewById(R.id.iv_account_profile);
