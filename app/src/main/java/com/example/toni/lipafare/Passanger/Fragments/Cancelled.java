...
import com.example.toni.lipafare.Passanger.PassangerAdapter.CancelledTripsAdapter;
...
public class Cancelled extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_cancelled, container, false);

        //views
        no_trips = (LinearLayout) mView.findViewById(R.id.linear_cancelled_frag);
                    ...
                    cs.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (Integer.valueOf(dataSnapshot.child("status").getValue().toString()) == 2) {
                                ...
                                CancelledTripsAdapter upcomingTripsAdapter = new CancelledTripsAdapter(getActivity(), myTickets, ticketKeys);
